        ...
        <div>
            <Navbar />
                ...
                <div className='container py-5'>
                    <p className='bg-tertiaryColor'>Il n’y a rien de plus simple pour devenir partenaire de IFABit.
                    ...
                    <div className='py-3 '>
                        <div className='card bg-borderColor'>
                            <div className='card-header bg-dark text-white bg-primaryColorback'>
                                <h2 className='bg-secondaryColor'>Rémunération</h2>
                            </div>
                            <div className='card-body'>
                                <p className='bg-tertiaryColor'>Les partenaires gagnent une commission sur les processus de retraits opérés sur leur compte.
                    ...
                    <div className='py-3'>
                        <div className='card bg-borderColor'>
                            <div className='card-header bg-dark text-white bg-primaryColorback'>
                                <h2 className='bg-secondaryColor'>Processus d'adhésion</h2>
                            </div>
                            <div className='card-body '>
                    ...
                    <div className='py-3'>
                        <div className='card bg-borderColor'>
                            <div className='card-header bg-dark text-white bg-primaryColorback'>
                                <h2 className='bg-secondaryColor'>Conditions et Liste des pièces à fournir pour devenir partenaire IFABIT</h2>
                            </div>
                            <div className='card-body '>
                                <ul className='liste bg-tertiaryColor '>
