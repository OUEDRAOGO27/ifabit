                ...
                <div className='container py-5'>
                    ...
                    <div className='row py-5'>
                        <div className='col-md-6'>
                            ...
                            <a className='btn btn-binance btn-lg text-uppercase py-2' href='https://www.binance.com/fr'>voir le broker</a>
                        </div>
                        <div className='col-md-6'>
                    ...
                    <div className='row py-5'>
                        ...
                        <div className='col-md-6'>
                            ...
                            <a className='btn btn-danger btn-lg text-uppercase py-2' href='https://www.ironfx.com/fr/'>voir le broker</a>
                        </div>
                    </div>
                </div>
            <Footer />
